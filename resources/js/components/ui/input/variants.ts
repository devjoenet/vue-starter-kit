...
export const inputVariants = tv({
  base: 'peer w-full min-w-0 text-base leading-6 text-foreground transition-[border-color,box-shadow,background-color,color] outline-none focus-visible:ring-2 focus-visible:ring-[color:var(--ring)]/30 disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-55',
  variants: {
    variant: {
...
export const inputLabelVariants = tv({
  base: 'pointer-events-none absolute top-4 origin-left text-sm text-muted-foreground transition-[transform,color,top] duration-150 peer-placeholder-shown:top-4 peer-placeholder-shown:scale-100 peer-focus:top-2 peer-focus:scale-90 peer-focus:text-[var(--ring)] peer-disabled:opacity-60 peer-[&:not(:placeholder-shown)]:top-2 peer-[&:not(:placeholder-shown)]:scale-90',
  variants: {
    variant: {
...
export const inputAssistiveTextVariants = tv({
  base: 'text-xs',
  variants: {
    state: {
