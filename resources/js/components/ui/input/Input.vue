  ...
  <div class="w-full">
    <div class="group relative" @mousedown="handleMousedown">
      ...
      <FieldClearControl
        ...
        :class="
          cn(
            'absolute top-1/2 z-20 flex size-6 -translate-y-1/2 items-center justify-center rounded-full text-(--field-label) transition-colors duration-150 hover:text-(--field-focus) focus-visible:ring-2 focus-visible:ring-(--field-focus) focus-visible:outline-none',
            clearOffset,
          )
        "
