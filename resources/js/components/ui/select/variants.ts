...
export const selectLabelVariants = tv({
  base: 'absolute top-4 origin-left text-sm text-muted-foreground transition-[transform,color,top,background-color] duration-150 peer-focus:top-2 peer-focus:scale-90 peer-focus:text-[var(--ring)] peer-disabled:opacity-60 peer-data-[filled=true]:top-2 peer-data-[filled=true]:scale-90 peer-data-[open=true]:top-2 peer-data-[open=true]:scale-90 peer-data-[open=true]:text-[var(--ring)]',
  variants: {
    variant: {
    ...
    state: {
      default: '',
      primary: 'text-primary peer-focus:text-primary peer-data-[open=true]:text-primary',
...
export const selectOptionVariants = tv({
  base: 'data-[state=checked]:bg-muted/65 data-[state=checked]:text-foreground',
  variants: {
    variant: {
