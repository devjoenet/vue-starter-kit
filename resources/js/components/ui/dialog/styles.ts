...
const dialogFeedbackVariants = {
  ...
  destructive:
    'border-destructive/35 bg-card text-foreground [&_[data-slot=dialog-title]]:text-destructive [&_[data-slot=dialog-description]]:text-destructive/90',
  ...
  warning:
    'border-warning/35 bg-card text-foreground [&_[data-slot=dialog-title]]:text-warning [&_[data-slot=dialog-description]]:text-warning',
  success:
    'border-success/35 bg-card text-foreground [&_[data-slot=dialog-title]]:text-success [&_[data-slot=dialog-description]]:text-success/90',
} as const;
...
export const dialogCloseVariants = cva(
  "absolute top-4 right-4 rounded-xs opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:ring-2 focus:ring-offset-2 focus:outline-hidden disabled:pointer-events-none [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        default:
          'focus:ring-ring data-[state=open]:bg-accent data-[state=open]:text-muted-foreground',
        destructive:
          'focus:ring-destructive/30 data-[state=open]:bg-destructive/12 data-[state=open]:text-destructive',
        info: 'focus:ring-info/30 data-[state=open]:bg-info/12 data-[state=open]:text-info',
        warning:
          'focus:ring-warning/30 data-[state=open]:bg-warning/15 data-[state=open]:text-warning',
        success:
          'focus:ring-success/30 data-[state=open]:bg-success/12 data-[state=open]:text-success',
      },
    },
    defaultVariants: {
      variant: 'default',
...
export const dialogScrollCloseVariants = cva(
