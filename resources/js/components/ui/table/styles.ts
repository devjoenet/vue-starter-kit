...
export const tableRowVariants = cva('border-b border-border/55 transition-colors even:bg-muted/20 hover:bg-muted/35 data-[state=selected]:bg-muted/45 dark:even:bg-muted/24 dark:hover:bg-muted/40 dark:data-[state=selected]:bg-muted/50');
...
export const tableCellVariants = cva('px-4 py-3 align-top text-sm leading-6 break-words md:align-middle md:whitespace-nowrap');
