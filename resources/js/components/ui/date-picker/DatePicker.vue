      ...
      <DropdownMenu v-model:open="open" :modal="false">
        ...
        >
          ...
          >
            ...
            <button
              type="button"
              class="inline-flex items-center rounded-md bg-primary px-2 py-1 text-xs font-medium text-primary-foreground transition-colors hover:bg-primary/90 disabled:opacity-45"
              :disabled="disabled || readonly"
              @click="selectToday"
            >
              Today
