  ...
  <div>
    <div class="shell-header-band border-b border-sidebar-border/70">
      <div class="mx-auto flex min-h-[4.5rem] items-center gap-4 px-4 py-3 md:max-w-7xl">
        ...
        <Link
          :href="dashboard()"
          class="flex min-w-0 items-center gap-x-3 rounded-[1.25rem] border border-sidebar-border/60 bg-background/24 px-3 py-2"
        >
          <AppLogo />
          <div class="hidden min-w-0 xl:block">
            ...
            <p class="text-sm leading-6 text-foreground/88">
              Custom business apps and client-ready demos
            </p>
          </div>
        </Link>
        ...
        <div
          class="hidden rounded-full border border-sidebar-border/55 bg-background/20 px-4 py-2 text-[0.68rem] font-semibold tracking-[0.16em] text-muted-foreground uppercase lg:inline-flex"
        >
          Client-ready system
        </div>
    ...
    <div
      ...
      class="flex w-full border-b border-sidebar-border/60"
    >
      <div
        class="mx-auto flex min-h-12 w-full items-center justify-start px-4 text-muted-foreground md:max-w-7xl"
      >
        <div class="flex min-w-0 items-center gap-3">
          <span
            class="hidden text-[0.68rem] font-semibold tracking-[0.18em] text-muted-foreground/80 uppercase sm:block"
          >
            Current surface
          </span>
