...
<template>
  <section v-bind="attrs" data-slot="admin-permissions-index-table" class="space-y-3">
    ...
    <div v-if="props.permissions.length" id="admin-permissions-index-mobile-list" class="grid gap-3 md:hidden">
      <Card v-for="permission in props.permissions" :key="permission.id" appearance="filled" variant="neutral" class="gap-4 px-5 py-5">
    ...
    <Card v-else appearance="filled" variant="neutral" class="px-5 py-5 text-sm text-muted-foreground md:hidden"> No permissions match the current filters. </Card>
