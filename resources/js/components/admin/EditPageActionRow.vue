...
const props = withDefaults(
  ...
  }>(),
  {
    ...
    description:
      'Review the current state, then save and return to the index when you are ready.',
...
<template>
  <div
    :class="[
      'surface-editor-action-zone flex flex-col gap-5 rounded-[1.5rem] px-5 py-5',
      props.class,
    ]"
  >
    <div class="space-y-2">
      ...
      <p
        v-if="status"
        :class="['text-sm font-medium', statusClassNames[statusTone]]"
      >
        {{ status }}
      </p>
    </div>
