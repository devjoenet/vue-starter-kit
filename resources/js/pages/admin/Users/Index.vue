...
<template>
  <div id="admin-users-index-page" class="motion-stage space-y-6 px-4">
    ...
    >
      <div class="space-y-1.5">
        ...
        <p class="text-sm leading-6 text-muted-foreground">
          Filter or sort each column without relying on the desktop table
          header.
        </p>
      </div>
    ...
    >
      ...
      >
        <div class="flex items-start justify-between gap-4">
          ...
          <div
            class="rounded-full border border-secondary/30 bg-secondary/14 px-3 py-1 text-xs font-semibold text-secondary"
          >
    ...
    <Card
      v-else
      id="admin-users-index-mobile-empty-state"
      variant="default"
