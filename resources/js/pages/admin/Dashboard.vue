...
<template>
  ...
  >
    <div
      class="pointer-events-none absolute -top-24 right-0 size-72 rounded-full bg-primary/15 blur-3xl"
    />
    <div
      class="pointer-events-none absolute -bottom-32 left-0 size-80 rounded-full bg-secondary/15 blur-3xl"
    />
    <div
    ...
    <div class="relative grid auto-rows-[170px] gap-4 md:grid-cols-6">
      ...
      >
        <div
          class="pointer-events-none absolute inset-0 bg-linear-to-br from-primary/10 via-transparent to-transparent opacity-0 transition-opacity duration-200 group-hover:opacity-100"
        />
        <PlaceholderPattern />
      </div>
      <div
      ...
      >
        <div
          class="pointer-events-none absolute inset-0 bg-linear-to-br from-secondary/15 via-transparent to-transparent opacity-0 transition-opacity duration-200 group-hover:opacity-100"
        />
        <PlaceholderPattern />
      </div>
      <div
      ...
      >
        <div
          class="pointer-events-none absolute inset-0 bg-linear-to-br from-accent/15 via-transparent to-transparent opacity-0 transition-opacity duration-200 group-hover:opacity-100"
        />
        <PlaceholderPattern />
      </div>
    </div>
