...
const actionStatus = computed(() =>
  form.isDirty ? 'Unsaved changes are ready to save.' : 'No unsaved changes.',
);
const selectedGroupLabel = computed(
  () => form.group_label || toTitleCase(form.group),
);
      ...
      <div class="relative space-y-6">
        ...
        >
          <PermissionEditorForm
            ...
            :save-description="
              form.isDirty
                ? 'Save the updated label and group metadata, then return to the permissions index.'
                : 'You can close this editor now, or keep reviewing the current catalog entry.'
            "
          ...
          >
            ...
            <h2 class="text-lg font-semibold tracking-tight">
              The key is fixed. The catalog language is not.
            </h2>
            <p class="text-sm leading-6 text-muted-foreground">
              Use the editable fields to make the permission clearer for future
              role designers and auditors. If you move this permission into a
              different group or rewrite the group description, that shared
              metadata updates everywhere the group is shown.
            </p>
          </Card>
        </div>
      </div>
