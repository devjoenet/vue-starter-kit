  ...
  >
    ...
    >
      ...
      >
          ...
          <ul class="mb-4 flex flex-col lg:mb-6">
            ...
            >
              <span class="relative bg-card py-1">
                <span
                  class="flex h-3.5 w-3.5 items-center justify-center rounded-full border border-border bg-background shadow-[0px_0px_1px_0px_rgb(0_0_0/0.04),0px_1px_2px_0px_rgb(0_0_0/0.08)]"
                >
              ...
              <span>
                ...
                <a
                  ...
                  target="_blank"
                  class="ml-1 inline-flex items-center space-x-1 font-medium text-primary underline underline-offset-4 transition hover:text-accent"
                >
            ...
            <li
              class="relative flex items-center gap-4 py-2 before:absolute before:top-0 before:bottom-1/2 before:left-[0.4rem] before:border-l before:border-border"
            >
              <span class="relative bg-card py-1">
                <span
                  class="flex h-3.5 w-3.5 items-center justify-center rounded-full border border-border bg-background shadow-[0px_0px_1px_0px_rgb(0_0_0/0.04),0px_1px_2px_0px_rgb(0_0_0/0.08)]"
        ...
        >
          <svg
            class="w-full max-w-none translate-y-0 text-primary opacity-100 transition-all duration-750 starting:translate-y-6 starting:opacity-0"
            viewBox="0 0 438 104"
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
          >
          ...
          <div
            class="absolute inset-0 rounded-t-lg shadow-[inset_0px_0px_0px_1px_rgb(0_0_0/0.08)] lg:overflow-hidden lg:rounded-t-none lg:rounded-r-lg"
          />
        </div>
      </main>
    </div>
