...
{
    private const string LegacySharedUserModelType = 'App\\Modules\\Shared\\Models\\User';

    private const string CurrentUserModelType = User::class;
    ...
    public function up(): void
    {
        DB::transaction(function (): void {
            $this->backfillModelType(
                ...
                pivotColumn: 'role_id',
                fromModelType: self::LegacySharedUserModelType,
    ...
    public function down(): void
    {
        DB::transaction(function (): void {
            $this->backfillModelType(
                ...
                toModelType: self::LegacySharedUserModelType,
            );
