...
{
    private const string IntermediateUserModelType = 'App\\Modules\\Users\\Models\\User';
    ...
    public function up(): void
    {
        DB::transaction(function (): void {
            $this->backfillModelType(
                ...
                pivotColumn: 'role_id',
                fromModelType: self::IntermediateUserModelType,
    ...
    public function down(): void
    {
        DB::transaction(function (): void {
            $this->backfillModelType(
                ...
                toModelType: self::IntermediateUserModelType,
            );
